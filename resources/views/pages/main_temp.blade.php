...
<head>
    ...
    <meta property="og:site_name" content="Eziline | Metronic" />
    ...
    <link href="{{ asset('demo1/plugins/custom/vis-timeline/vis-timeline.bundle.css') }}" rel="stylesheet" type="text/css" />
                            ...
                            <div class="d-flex flex-stack">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-1">
                                        <div class="fs-6 fw-semibold text-gray-800 fw-semibold mb-0 me-1">
                                            Regular License
                                        </div>
                                            ...
                                            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 active">
                                                ...
                                                <span class="d-flex">
                                                    ...
                                                    <span class="ms-4">
                                                        ...
                                                        <span class="fw-semibold fs-4 text-muted">If you need more info, please check it
                                                            out</span>
                                                    </span>
                                                    <!--end::Info-->
                                                </span>
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xxl-6">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary active d-flex text-start p-6" data-kt-button="true">
                                                        ...
                                                        <span class="ms-5">
                                                            ...
                                                            <span class="fw-semibold fs-7 text-gray-600">Withdraw money to your bank account per
...
Experience share market at your fingertips with TICK PRO stock investment mobile trading app</textarea>
    ...
    <script src="{{ asset('demo1/plugins/custom/vis-timeline/vis-timeline.bundle.js') }}"></script>
    ...
    <script src="{{ asset('demo1/js/custom/apps/chat/chat.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-app.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-campaign.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/type.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/budget.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/settings.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/team.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/targets.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/files.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/complete.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/create-project/main.js') }}"></script>
    <script src="{{ asset('demo1/js/custom/utilities/modals/users-search.js') }}"></script>
